        ...
        <>
          <header>
            ...
            <div className="details-overview">
              ...
              <p>{genre}</p>
              <p>
                <span>⭐</span>IMDB rating {imdbRating}
              </p>
            </div>
          </header>
...
function WatchedMovieList({ watched, onDelectWatched }) {
  return (
    <ul className="list">
      {watched.map((movie) => (
        <WatchedMovie
          movie={movie}
          key={movie.imdbID}
          onDelectWatched={onDelectWatched}
        ></WatchedMovie>
      ))}
    </ul>
  );
...
function WatchedMovie({ movie, onDelectWatched }) {
  return (
    <li>
      <img src={movie.poster} alt={`${movie.title} poster`} />
      <h3>{movie.title}</h3>
